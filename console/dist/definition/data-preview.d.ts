import type { DArray, DBigInt, DBuffer, DCollection, DDataView, DDate, DElement, DError, DFunction, DNill, DNumber, DPromise, DRecord, DRegExp, DString, DSymbol, DTypedArray, RealItem } from './data';
